...
class VentasController extends Controller
{
    ...
    foreach ($productos as $producto) {
        ...
        [$tienePromocion,$tipo,$porcentajeDescuento] = (new Promociones_detallesController())->productoTienePromocionVigente($producto->codigo);
        $precioConDescuento = $producto->precio;
        // Calcular el precio con descuento si aplica
        if ($tienePromocion && $tipo=='con_descuento') {
